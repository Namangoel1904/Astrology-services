<?php
/**
 * Plugin Name: Numerology Prediction
 * Plugin URI: https://yoursite.com
 * Description: A numerology prediction plugin with beautiful table structure
 * Version: 1.0.0
 * Author: Your Name
...
class NumerologyPlugin {
    ...
    public function __construct() {
        ...
        add_shortcode('numerology_page', array($this, 'numerology_shortcode'));
    ...
    public function enqueue_scripts() {
        wp_enqueue_style('numerology-style', NUMEROLOGY_PLUGIN_URL . 'assets/numerology-style.css', array(), '1.0.0');
    }
