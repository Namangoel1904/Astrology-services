...
const UPSTREAM_URL = 'https://api.vedicastroapi.com/v3-json/horoscope/divisional-charts';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const params = { api_key: API_KEY, dob, tob, lat, lon, tz, lang, div: 'D1', response_type: 'planet_object' };
